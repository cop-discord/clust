...
class Boosters(commands.Cog):
    ...
    @boosterrole.command(
        name="setup",
        help="set the boosterrole module",
        brief="manage guild",
    )
    ...
    @boosterrole.command(help="unset the boosterrole module", brief="manage guild")
    @Perms.get_perms("manage_guild")
    async def unset(self, ctx: commands.Context):
        ...
        embed = discord.Embed(
            ...
            help="Are you sure you want to unset the boosterrole module? This action is **IRREVERSIBLE**",
        )
    ...
    @boosterrole.command(
        help="set a base role for boosterrole module",
        brief="manage guild",
    )
    @Perms.get_perms("manage_guild")
    ...
    @boosterrole.command(help="create a booster role", usage="<name>")
    ...
    @boosterrole.command(help="edit the booster role name", usage="[name]")
    @has_booster_role()
    ...
    @boosterrole.command(help="edit the role icon", usage="[emoji]")
    @has_booster_role()
    async def icon(
    ...
    @boosterrole.command(help="change the booster role color", usage="[color]")
    @has_booster_role()
    ...
    @boosterrole.command(help="edit the role hoist")
    @has_booster_role()
    ...
    @boosterrole.command(help="delete the booster role")
    @has_booster_role()
    ...
    @boosterrole.command(help="edit a booster role")
    async def edit(self, ctx: commands.Context):
        ...
        if role is None:
            options = [
                discord.SelectOption(
                    ...
                    emoji="<:trash:1136338907101937845>",
                ),
                discord.SelectOption(
                    label="cancel",
                    help="cancel the booster role edit",
                    emoji=self.bot.no,
                ),
            ]
        else:
            options = [
                discord.SelectOption(
                    label="name",
                    help="change the booster role name",
                    emoji="<:channel:1136343398350082099>",
                ),
                discord.SelectOption(
                    label="color",
                    help="change the color of your role",
                    emoji="<:01star:1126834425905291284>",
                ),
                discord.SelectOption(
                    label="icon",
                    help="change the role icon",
                    emoji="<a:white_user:1126834512840630343>",
                ),
                discord.SelectOption(
                    label="hoist",
                    help="make your role hoisted or not",
                    emoji="<:unghost:1126829806303051847>",
                ),
                discord.SelectOption(
                    label="delete",
                    help="delete your booster role",
        ...
        embed = discord.Embed(
            ...
            help="customize your custom role using the dropdown menu below",
        )
