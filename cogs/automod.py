...
class AutoMod(commands.Cog):
        ...
        if any(invite in message.content for invite in invites):
            ...
            if check is not None:
                ...
                data = await self.bot.session.json(
                    DISCORD_API_LINK + link, proxy=self.bot.proxy_url, ssl=False
                )
                try:
    ...
    @chatfilter.command(
        name="add",
        help="add a word to the chatfilter",
        brief="manage guild",
        usage="[word]",
    )
    ...
    @chatfilter.command(
        name="remove",
        help="remove a word from the chatfilter",
        brief="manage guild",
        usage="[word]",
    )
    @Perms.get_perms("manage_guild")
    ...
    @chatfilter.command(name="list", help="returns a list of blacklisted words")
        ...
        for result in results:
            ...
            if l == 10:
                ...
                number.append(
                    discord.Embed(
                        color=self.bot.color,
                        title=f"blacklisted words ({len(results)})",
    ...
    @chatfilter.group(
        name="whitelist",
        help="manage whitelist for chatfilter",
        aliases=["wl"],
    )
    ...
    @cf_whitelist.command(
        brief="manage guild",
        help="whitelist a channel from chatfilter",
        name="channel",
    )
    @Perms.get_perms("manage_guild")
    ...
    @cf_whitelist.command(
        brief="manage guild",
        help="whitelist an user from chatfilter",
        name="user",
    )
    @Perms.get_perms("manage_guild")
    ...
    @chatfilter.group(
        name="unwhitelist",
        help="remove channels or users from chatfilter whitelist",
        aliases=["uwl"],
    )
    ...
    @cf_unwhitelist.command(
        name="channel",
        help="unwhitelist a channel from chatfilter",
        brief="manage guild",
    )
    @Perms.get_perms("manage_guild")
    ...
    @cf_unwhitelist.command(
        name="user",
        help="unwhitelist an user from chatfilter",
        brief="manage guild",
    )
    @Perms.get_perms("manage_guild")
    ...
    @chatfilter.group(
        name="whitelisted",
        help="returns a list of whitelisted channels or users",
    )
    ...
    @anti_spam.command(
        name="seconds",
        help="set antispam's delay time",
        brief="manage guild",
        usage="[seconds]",
    )
    @Perms.get_perms("manage_guild")
    ...
    @anti_spam.group(
        name="whitelist",
        help="manage whitelist for anti spam",
        aliases=["wl"],
    )
    ...
    @antispam_whitelist.command(
        brief="manage guild",
        help="whitelist a channel from anti spam",
        name="channel",
    )
    @Perms.get_perms("manage_guild")
    ...
    @antispam_whitelist.command(
        brief="manage guild",
        help="whitelist an user from anti spam",
        name="user",
    )
    @Perms.get_perms("manage_guild")
    ...
    @anti_spam.group(
        name="unwhitelist",
        help="remove channels or users from antispam whitelist",
        aliases=["uwl"],
    )
    ...
    @antispam_unwhitelist.command(
        name="channel",
        help="unwhitelist a channel from anti spam",
        brief="manage guild",
    )
    @Perms.get_perms("manage_guild")
    ...
    @antispam_unwhitelist.command(
        name="user",
        help="unwhitelist an user from anti spam",
        brief="manage guild",
    )
    @Perms.get_perms("manage_guild")
    ...
    @antispam_whitelisted.command(
        name="users", help="return a list of whitelisted users"
    )
    ...
    @anti_invite.command(name="disable", help="disable anti invite", aliases=["d"])
    @Perms.get_perms("manage_guild")
    ...
    @anti_invite.group(
        name="whitelist",
        help="manage whitelist for anti invite",
        aliases=["wl"],
    )
    ...
    @antiinvite_whitelist.command(
        brief="manage guild",
        help="whitelist a channel from anti invite",
        name="channel",
    )
    @Perms.get_perms("manage_guild")
    ...
    @antiinvite_whitelist.command(
        brief="manage guild",
        help="whitelist an user from antiinvite",
        name="user",
    )
    @Perms.get_perms("manage_guild")
    ...
    @anti_invite.group(
        name="unwhitelist",
        help="remove channels or users from antilink whitelist",
        aliases=["uwl"],
    )
    ...
    @antiinvite_unwhitelist.command(
        name="channel",
        help="unwhitelist a channel from antiinvite",
        brief="manage guild",
    )
    @Perms.get_perms("manage_guild")
    ...
    @antiinvite_unwhitelist.command(
        name="user",
        help="unwhitelist an user from antiinvite",
        brief="manage guild",
    )
    @Perms.get_perms("manage_guild")
