...
from extensions.control import Messages, Perms
...
class Chat(commands.Cog):
    ...
    @autoresponder.command(
        name="variables",
        help="returns variables for autoresponder",
    )
    async def ar_variables(self, ctx: commands.Context):
        await ctx.invoke(self.bot.get_command("embed variables"))

    @autoresponder.command(name="list", help="returns a list of all autoresponders")
    ...
    @autoreact.command(
        name="add",
        help="make the bot react with emojis on your message",
        brief="manage guild",
    ...
    @autoreact.command(
        name="remove",
        help="remove auto reactions from a content",
        brief="manage guild",
        usage="[content]",
    )
    @Perms.get_perms("manage_guild")
    ...
    @autoreact.command(
        name="list",
        help="return a list of autoreactions in this server",
    )
