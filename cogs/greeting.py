...
class Greet(commands.Cog):
    ...
    @boost.command(
        name="message",
        help="configure the boost message",
        brief="manage guild",
        usage="[message]",
    )
    ...
    @boost.command(
        name="channel",
        help="configure the boost channel",
        brief="manage guild",
        usage="[channel]",
    )
    @Perms.get_perms("manage_guild")
    async def boost_channel(
        ...
        if channel is None:
            ...
            if not check:
                return await ctx.send_warning("Boost **channel** is not configured")
            await self.bot.db.execute(
    ...
    async def boost_delete(self, ctx: commands.Context):
        ...
        if not check:
            return await ctx.send_warning("Boost module is not configured")
    ...
    async def boost_test(self, ctx: commands.Context):
        ...
        if res:
            ...
            if channel is None:
                return await ctx.send_error("Channel **not** found")
            try:
                x = await EmbedBuilder.to_object(
    ...
    @leave.command(
        name="variables",
        help="return the variables for the leave message",
    )
    async def leave_variables(self, ctx: commands.Context):
        await ctx.invoke(self.bot.get_command("embed variables"))

    @leave.command(name="config", help="returns stats of the leave message")
    ...
    @leave.command(
        name="message",
        help="configure the leave message",
        brief="manage guild",
        usage="[message]",
    )
    @Perms.get_perms("manage_guild")
    ...
    @leave.command(
        name="channel",
        help="configure the leave channel",
        brief="manage guild",
        usage="[channel]",
    )
    @Perms.get_perms("manage_guild")
    async def leave_channel(
        ...
        if channel is None:
            ...
            if not check:
                return await ctx.send_warning("Leave **channel** is not configured")
            await self.bot.db.execute(
    ...
    async def leave_delete(self, ctx: commands.Context):
        ...
        if not check:
            return await ctx.send_warning("Leave module is not configured")
    ...
    @welcome.command(
        name="variables",
        help="return the variables for the welcome message",
    )
    async def welcome_variables(self, ctx: commands.Context):
        await ctx.invoke(self.bot.get_command("embed variables"))

    @welcome.command(name="config", help="returns stats of the welcome message")
    ...
    @welcome.command(
        name="message",
        help="configure the welcome message",
        brief="manage guild",
        usage="[message]",
    )
    @Perms.get_perms("manage_guild")
    ...
    @welcome.command(
        name="channel",
        help="configure the welcome channel",
        brief="manage guild",
        usage="[channel]",
    )
    @Perms.get_perms("manage_guild")
    async def welcome_channel(
        ...
        if channel is None:
            ...
            if not check:
                return await ctx.send_warning("Welcome **channel** is not configured")
            await self.bot.db.execute(
    ...
    @welcome.command(
        name="delete",
        help="delete the welcome module",
        brief="manage guild",
    )
    @Perms.get_perms("manage_guild")
    async def welcome_delete(self, ctx: commands.Context):
        ...
        if not check:
            return await ctx.send_warning("Welcome module is not configured")
        await self.bot.db.execute(
