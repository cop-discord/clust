        ...
        if isinstance(ctx, commands.Context):
            return await ctx.reply(
                embed=discord.Embed(
                    ...
                    description=f"{self.bot.yes} {ctx.author.mention}: {message}",
                )
            )
        else:
            return await ctx.response.send_message(
                embed=discord.Embed(
                    color=self.bot.color,
                    description=f"{self.bot.yes} {ctx.user.mention}: {message}",
                ),
                ephemeral=ephemeral,
            )
    ...
    async def send_error(
        ...
        if isinstance(ctx, commands.Context):
            return await ctx.reply(
                embed=discord.Embed(
                    color=self.bot.color,
                    description=f"{self.bot.no} {ctx.author.mention}: {message}",
                )
            )
        else:
            return await ctx.response.send_message(
                embed=discord.Embed(
                    color=self.bot.color,
                    description=f"{self.bot.no} {ctx.user.mention}: {message}",
                ),
                ephemeral=ephemeral,
            )
    ...
    async def send_warning(
        ...
        if isinstance(ctx, commands.Context):
            return await ctx.reply(
                embed=discord.Embed(
                    color=self.bot.color,
                    description=f"{self.bot.warning} {ctx.author.mention}: {message}",
                )
            )
        else:
            return await ctx.response.send_message(
                embed=discord.Embed(
                    color=self.bot.color,
                    description=f"{self.bot.warning} {ctx.user.mention}: {message}",
                ),
                ephemeral=ephemeral,
            )
